@testset "Flux summary" begin
    ...
    @test isapprox(fr.biomass_fluxes["BIOMASS_Ecoli_core_w_GAM"], 0.8739215022690006; atol=TEST_TOLERANCE)
    ...
    @test isapprox(fr.unbounded_fluxes["EX_h2o_e"], 29.175827202663395; atol=TEST_TOLERANCE) 
end
