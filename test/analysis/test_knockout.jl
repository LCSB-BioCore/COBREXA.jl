@testset "single_knockout" begin
    ...
    add!(m, Reaction("v2", metabolites=Dict("A" => -1.0, "B" => 1.0), grr=[["g1", "g2"]]))
    add!(m, Reaction("v3", metabolites=Dict("A" => -1.0, "B" => 1.0), grr=[["g1"], ["g2"]]))
    add!(m, Reaction("v4", metabolites=Dict("A" => -1.0, "B" => 1.0), grr=[["g1", "g2"], ["g2"]]))
...
@testset "multiple_knockouts" begin
    ...
    add!(m, Gene("g2"))
    add!(m, Gene("g3"))
    add!(m, Reaction("v1", metabolites=Dict("A" => -1.0, "B" => 1.0), grr=[["g1"], ["g3"]]))
    add!(m, Reaction("v2", metabolites=Dict("A" => -1.0, "B" => 1.0), grr=[["g1", "g2"], ["g3"]]))
    add!(m, Reaction("v3", metabolites=Dict("A" => -1.0, "B" => 1.0), grr=[["g1"], ["g2"], ["g3"]]))
