...
"""
Accessors.constraints(model::ObjectModel)::StringVecType = collect(keys(model.metabolites))
...
"""
Accessors.n_constraints(model::ObjectModel)::Int = length(model.metabolites)
