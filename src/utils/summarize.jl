...
function summarize(
    ...
    #         data; 
    #         header = [
    #             titlecase(String(semantics)), "Flux"
    #             ],
    #         ),
    #     )
...
summarize(modelwithresult; kwargs...) = summarize(:reaction, modelwithresult; kwargs...)

# function summarize(sol, kwargs...)
#     if typeof(sol.result)
#         summarize_single_solution(sol, kwargs...)
#     end
# end
